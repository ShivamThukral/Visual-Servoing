...
//        key->Translation(ignition::math::Vector3d(0.9, 0.975, 1.2)); // top right corner
//        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
//
//        key = anim->CreateKeyFrame(8);
//        key->Translation(ignition::math::Vector3d(0.2, 0.975, 1.2)); // top left corner
//        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
//
...
// -----------------------------------------------------------------------------
        ...
        key = anim->CreateKeyFrame(0);
        key->Translation(ignition::math::Vector3d(0.9, 0.975, 1.6)); // top right corner
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(8);
        key->Translation(ignition::math::Vector3d(0.2, 0.975, 0.9)); // top left corner
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
